...
1. ADAMA_Models:            
2D grids at depths (0.5:0.5:7.5,10,12.5,17.5,22.5,27.5,30.5,32.5,40.5,42.5 km) for ADAMA and Litho, and phase and group maps for love and Rayleigh waves in .txt, .nc, and .mat formats.
